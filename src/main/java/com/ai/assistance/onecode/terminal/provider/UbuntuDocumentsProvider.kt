package com.ai.assistance.onecode.terminal.provider
...
class UbuntuDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.ai.assistance.onecode.documents.ubuntu"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "Onecode Ubuntu")
        row.add(DocumentsContract.Root.COLUMN_SUMMARY, "Access Onecode Ubuntu terminal files")
