package com.ai.assistance.onecode.terminal.data
...
data class TerminalSessionData(
    ...
    val terminalSession: com.ai.assistance.onecode.terminal.TerminalSession? = null,
    val pty: com.ai.assistance.onecode.terminal.Pty? = null, // PTY 对象，用于获取终端模式
